                    ...
                    <div class="tab-content">
                        ...
                        <div id="product-details" class="tab-pane" role="tabpanel">
                            <div class="product-details-manufacturer">
                                <a href="#">
                                    <img src="{{url('public')}}/limupa/images/product-details/1.jpg" alt="Product Manufacturer Image">
                                </a>
                                                    ...
                                                    <div class="modal-inner-area row">
                                                        <div class="col-lg-6">
                                                           <div class="li-review-product">
                                                               <img src="{{url('public')}}/limupa/images/product/large-size/3.jpg" alt="Li's Product">
